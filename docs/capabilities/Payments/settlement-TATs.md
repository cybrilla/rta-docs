---
sidebar_position: 6
sidebar_label: Settlement TATs
title: Settlement TATs
---

# Payments Settlement TATs

## Payment modes and their settlement TATs

| Payment Modes | Day of Debit to Investor's Account | Day of Unit Allotment |
| --- | --- | --- |
| Netbanking/UPI (Basket Orders) | T | T+1 |
| Netbanking/UPI (Single Order Payments) | T | T/T+1** |
| UPI Autopay | T | T+1 |
| eNACH Mandate | T | T+1 |

> **Note:**  
> - ** **For single-order payments**, the same day settlement is subject to support of the payment methods and banks by the given AMC as detailed in the below table.

> **Note on NAV applicability:**
...
> - The **fund cut-off time** for *liquid funds* is **1:15 PM**, and for *non-liquid funds* is **2:45 PM**.  
...
> - **Unit allocation** is limited to **market working days** only.
...
| Kotak Mahindra Mutual Fund | Yes | Kotak Bank<br />State Bank of India<br />HDFC Bank<br />Axis Bank<br />ICICI Bank<br />IDBI Bank<br />IndusInd Bank<br />Yes Bank Ltd<br />IDFC FIRST Bank |
...
> **Note:**  
> - UPI is supported across all UPI-enabled banks.
